...
public class CommentController {
    ...
    public GlobalResponse<CommentResponseDto> writeComment(@PathVariable UUID postId, @RequestBody CommentRequestDto commentRequestDto) {
        CommentResponseDto responseDto = commentService.writeComment(postId,commentRequestDto);
    ...
    public GlobalResponse<CommentResponseDto> updateComment(@PathVariable UUID commentId, @RequestBody CommentRequestDto commentRequestDto) {
    ...
    public GlobalResponse<Void> deleteComment(@PathVariable UUID commentId) {
